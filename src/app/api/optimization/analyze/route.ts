...
export async function POST(req: NextRequest) {
  try {
    ...
    const { html, viewport, revision, liveEvidence, experimentEvidence } = parseResult.data;
    ...
    if (!wantsStream) {
      const result = analyzeDocumentUX(html, { viewport, revision, liveEvidence, experimentEvidence });
